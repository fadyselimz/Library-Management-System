...
public abstract class Library_Management {
    ...
    public static void addBook(Book book)  {
        try{
            ...
            writer.println( book.getbookId()+","+book.getBookName() + "," + book.getPublishingHouse() + "," + book.getAuther() + "," + book.getDateOfPublication() + "," + book.getGenre() + "," + book.getBookDiscription()+","+book.getStatus() );
            writer.close();
